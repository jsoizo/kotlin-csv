...
implementation("com.github.doyaaaaaken:kotlin-csv-js:1.9.0") // for Kotlin JS platform
...
```kotlin
@file:DependsOn("com.github.doyaaaaaken:kotlin-csv-jvm:1.9.0") // for JVM platform
@file:DependsOn("com.github.doyaaaaaken:kotlin-csv-js:1.9.0") // for Kotlin JS platform
```
