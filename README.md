...
<p>
  <img alt="Version" src="https://img.shields.io/badge/version-0.14.0-blue.svg?cacheSeconds=2592000" />
...
```kotlin
@file:DependsOn("com.github.doyaaaaaken:kotlin-csv-jvm:0.14.0")
```
